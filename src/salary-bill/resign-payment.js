...
import { ArrowLeft, Save, DollarSign, Calendar, FileText, User, LogOut, Calculator, Receipt, MessageCircle } from 'lucide-react';
    ...
    return (
        <div className="fixed inset-0 bg-gradient-to-br from-orange-50 via-white to-orange-50 flex flex-col overflow-hidden z-[100]">
            ...
            <button
                ...
                aria-label="Ask Resign Payment bot"
                title="Ask Resign Payment bot"
            >
