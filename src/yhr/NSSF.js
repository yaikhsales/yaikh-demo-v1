              ...
              <tbody>
                {records.map((rec) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 border-r border-b border-slate-200">
                      <div className="bg-slate-50 px-3 py-1.5 rounded border border-slate-200 inline-flex">
                        <span className="font-bold text-slate-700 text-[10px] tracking-widest uppercase">
                          {rec.nssfId}
                        </span>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 border-r border-b border-slate-200 text-center">
                      <span className="px-2 py-0.5 bg-white border border-slate-200 rounded text-[9px] font-bold text-teal-600 uppercase">
                        {rec.type}
                      </span>
                    </td>
                    <td className="px-6 py-4 border-r border-b border-slate-200">
