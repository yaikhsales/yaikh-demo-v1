              ...
              <tbody>
                {orders.map((rec) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 border-r border-b border-slate-200 text-center">
                      <span
                        className={`px-3 py-1 rounded-md text-[9px] font-black tracking-widest border ${rec.status === "COMPLETED" ? "bg-emerald-50 text-emerald-600 border-emerald-100" : "bg-amber-50 text-amber-600 border-amber-100"}`}
                      >
                        {rec.status}
                      </span>
                    </td>
                    <td className="px-6 py-4 border-r border-b border-slate-200 text-center">
                      <span className="px-2.5 py-1 bg-white border border-slate-200 rounded text-[9px] font-bold text-cyan-600 shadow-sm uppercase">
                        {rec.type}
                      </span>
                    </td>
                    <td className="px-6 py-4 border-r border-b border-slate-200">
                    ...
                    <td className="px-6 py-4 border-b border-slate-200">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 bg-cyan-600 text-white rounded text-[9px] font-bold uppercase hover:bg-cyan-700 transition-colors shadow-sm"
                        >
