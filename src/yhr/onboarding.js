...
import { ArrowLeft, Save, User, Briefcase, FileText, Calendar, CheckSquare, Building, MessageCircle } from 'lucide-react';
    ...
    return (
        <div className="fixed inset-0 bg-gradient-to-br from-purple-50 via-white to-purple-50 flex flex-col overflow-hidden z-[100]">
            ...
            <button
                ...
                aria-label="Ask Onboarding bot"
                title="Ask Onboarding bot"
            >
