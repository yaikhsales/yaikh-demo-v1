...
import { ArrowLeft, Save, FileText, User, Mail, Phone, Calendar, MapPin, Briefcase, GraduationCap, MessageCircle } from 'lucide-react';
    ...
    return (
        <div className="fixed inset-0 bg-gradient-to-br from-blue-50 via-white to-blue-50 flex flex-col overflow-hidden z-[100]">
            ...
            <button
                ...
                aria-label="Ask Recruitment bot"
                title="Ask Recruitment bot"
            >
