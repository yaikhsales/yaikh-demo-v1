 ...
 */
export const generateGeminiResponse = async (userMessage, botName = 'Yai 2', botContext = '', chatHistory = []) => {
    try {
...
export const shouldUseGemini = (message, hasPredefinedResponse) => {
    ...
    const questionWords = ['what', 'how', 'why', 'when', 'where', 'who', 'which', 'can', 'could', 'would', 'should', 'tell', 'explain', 'describe', 'help'];
