...
const MODULE_NAME = 'car_booking';

const CarBookingBot = ({ onClose }) => {
    const [messages, setMessages] = useState([
        { 
            from: 'bot', 
            text: 'Welcome to Car Booking Module! I can help you with:\n\n1. Show me car requests this month\n2. How many car booking requests approved by controller?\n3. How many car bookings issued to requestors?\n4. Show me car booking A4 items requested and issued\n5. What\'s the total car booking requestor requests?\n6. Give me car booking statistics\n7. Show me vehicle booking information\n\nAsk me anything about car booking requests!' 
        }
    ]);
    ...
    useEffect(() => {
        const saved = localStorage.getItem('car-booking-chat-history');
        if (saved) {
    ...
    useEffect(() => {
        if (chatHistory.length > 0) {
            localStorage.setItem('car-booking-chat-history', JSON.stringify(chatHistory));
        }
    }, [chatHistory]);
        ...
        <div className="flex flex-col h-full bg-gradient-to-br from-blue-50 to-cyan-50">
            ...
            <div className="flex items-center justify-between p-4 border-b border-blue-200 bg-white">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-lg font-semibold text-gray-800">Car Booking Module</h2>
                </div>
                <button
                    onClick={onClose}
                    className="p-2 hover:bg-gray-100 rounded-full transition-colors"
                ...
                <div className="absolute left-0 top-0 bottom-0 w-64 bg-white border-r border-gray-200 z-10 shadow-lg">
                    <div className="p-4 border-b border-gray-200">
                        ...
                        <button
                            ...
                            className="w-full px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors flex items-center gap-2"
                        >
                            <Plus size={16} />
                            New Chat
                        </button>
            ...
            <form onSubmit={handleSendMessage} className="p-4 border-t border-blue-200 bg-white">
                <div className="flex items-center gap-2">
                    <input
                        ...
                        placeholder="Ask about car booking requests..."
