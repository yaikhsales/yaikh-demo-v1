...
const YShop = ({ onBack }) => {
    ...
    const lowStockProducts = [
        {
            id: 1,
            name: 'កាំបិតអោបក្រោម',
            image: 'https://ym.yaikh.com/storage/inventory/Hqeq5bvpvjAKEHwxG1yV5pBZTwHrkp6G7L86gmgv.jpg',
            department: 'Office',
            inStock: 5.0,
            unit: 'pcs',
            max: 20,
        ...
        },
        {
            id: 2,
            name: 'កាំបិតផុងក្រោម',
            image: 'https://ym.yaikh.com/storage/inventory/M1jAgUq9bLJOGQBtfKRQoVAMOEOMfiNVoMEz408P.jpg',
            department: 'Office',
            inStock: 5.0,
            unit: 'pcs',
            max: 20,
        ...
        },
        {
            id: 3,
            name: 'កន្ត្រៃតូច',
            image: 'https://ym.yaikh.com/storage/inventory/73MWH4fmb53856Fvd27wcgsFl5kGiQ6x0ak6TDgy.jpg',
            department: 'Office',
            inStock: 0.0,
            unit: 'pcs',
            max: 20,
        ...
        },
        {
            id: 4,
            name: 'ដីសហុយ',
            image: 'https://ym.yaikh.com/storage/inventory/zOl0fQIYT1aqtPAajEEDjk7jrUcmB3oxhmOCCaEG.jpg',
            department: 'Office',
            inStock: 1.0,
            unit: 'pcs',
            max: 10,
        ...
        },
        {
            id: 5,
            name: 'សោគាស៊ាប់',
            image: 'https://ym.yaikh.com/storage/inventory/2esCddVnCG0LnJ6uh10G0SDl9Lx8ImZ9jalEmwOy.jpg',
            department: 'Office',
            inStock: 0.0,
            unit: 'pcs',
            max: 10,
        ...
        },
        {
            ...
            image: 'https://ym.yaikh.com/storage/inventory/nWJNIoNIoZ1UJArDzBsRQ2KITeJ89aRARA3frkxZ.jpg',
            department: 'Office',
            inStock: 18.0,
            unit: 'pcs',
            max: 30,
        ...
        },
        {
            id: 7,
            name: 'កាំបិតអោបលើ',
            image: 'https://ym.yaikh.com/storage/inventory/qsurADt3H0Y76PH0SmwiesfBHfbqkXqh3bnOiGj1.jpg',
            department: 'Office',
            inStock: 12.0,
            unit: 'pcs',
            max: 30,
        ...
        },
        {
            id: 8,
            name: 'ឌុយបី',
            image: 'https://ym.yaikh.com/storage/inventory/K4Twog7BbppKSaxaCGh9YEovy1AAovwf9n5tuuSc.jpg',
            department: 'Office',
            inStock: 14.0,
            unit: 'pcs',
            max: 30,
        ...
        },
        {
            id: 9,
            name: 'ដីសទៀន',
            image: 'https://ym.yaikh.com/storage/inventory/c6rbg0eRz9M9uCuvOdopNOMdVZmYK6dnFa6Vug6N.jpg',
            department: 'Office',
            inStock: 0.0,
            unit: 'pcs',
            max: 50,
    ...
    const healthyStockProducts = [
        {
            id: 1,
            name: 'ទ្រនាបអោប',
            image: 'https://ym.yaikh.com/storage/inventory/DmMyxb1Jb60a8XeSioGw7KbE4YRETTy6OYVK4QUQ.jpg',
            department: 'Office',
            inStock: 15,
            unit: 'pcs',
            max: 20,
        ...
        },
        {
            ...
            image: 'https://ym.yaikh.com/storage/inventory/9hGYAe334arxysnaZpqlJ5kOBCnL3zYzYYXkr6fq.jpg',
            department: 'Office',
            inStock: 18,
            unit: 'pcs',
            max: 25,
        ...
        },
        {
            id: 3,
            name: 'កាំបិតផុងលើ',
            image: 'https://ym.yaikh.com/storage/inventory/Nwm2QNQSsZjxVb1MfkbWYNiyGUMS1FDzB4LrgZOH.jpg',
            department: 'Office',
            inStock: 10,
            unit: 'pcs',
            max: 20,
        ...
        },
        {
            id: 4,
            name: 'ឈ្នាន់ម៉ាស៊ីន',
            image: 'https://ym.yaikh.com/storage/inventory/OLDMBFEOf4FucaoFPqLNip0bt7Z8tcQtB8IGbU0M.jpg',
            department: 'Office',
            inStock: 8,
            unit: 'pcs',
            max: 15,
        ...
        },
        {
            id: 5,
            name: 'ឆ្នាំងអ៊ុត',
            image: 'https://ym.yaikh.com/storage/inventory/RkyotRVvDZ2IEnFfw1rCqbHCTZLigWPCtdXLcbKR.jpg',
            department: 'Office',
            inStock: 500,
            unit: 'pcs',
            max: 600,
        ...
        },
        {
            ...
            image: 'https://ym.yaikh.com/storage/inventory/5g43iA5MRuz2aQR0Cr6CVCyZhEVlpRqu3BxEEc64.jpg',
            department: 'Office',
            inStock: 439,
            unit: 'pcs',
            max: 500,
        ...
        },
        {
            id: 7,
            name: 'ឈើកាវអោបលើធំ',
            image: 'https://ym.yaikh.com/storage/inventory/Bbp4ZajnBxPwjvK4AocRIWk6U0mAbzwJvKUuFo2M.jpg',
            department: 'Office',
            inStock: 15.0,
            unit: 'pcs',
            max: 30,
        ...
        },
        {
            ...
            image: 'https://ym.yaikh.com/storage/inventory/XiRtyVhL8Ea5uwLhVN0d0pz80Hz4lXzZhrXxtiig.jpg',
            department: 'Office',
            inStock: 900.0,
            unit: 'bottle',
            max: 1000,
        ...
        },
        {
            ...
            image: 'https://ym.yaikh.com/storage/inventory/v21fjWe89O8Bhy2RKNO6lhTSy0DwmujY93HP0fqD.jpg',
            department: 'Office',
            inStock: 10.0,
            unit: 'pcs',
            max: 20,
    ...
    const displayedHealthyStock = healthyStockProducts.slice(healthyStockStart, healthyStockEnd);
        ...
        <div key={product.id} className="bg-white rounded-lg shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow">
            <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-sm text-gray-800 mb-2 line-clamp-2">{product.name}</h3>
            ...
            <div className="grid grid-cols-2 gap-2 text-xs mb-3">
                <div>
                    ...
                    <span className="font-semibold text-gray-800 ml-1">{product.inStock} {product.unit}</span>
                </div>
                <div>
                    <span className="text-gray-600">Max:</span>
                    <span className="font-semibold text-gray-800 ml-1">{product.max} {product.unit}</span>
                </div>
                <div>
                    <span className="text-gray-600">Min:</span>
                    <span className="font-semibold text-gray-800 ml-1">{product.min} {product.unit}</span>
                </div>
                {isLowStock && product.needBuy > 0 && (
                    <div>
                        <span className="text-gray-600">Need Buy:</span>
                        <span className="font-semibold text-gray-800 ml-1">{product.needBuy} {product.unit}</span>
                    </div>
                )}
            </div>
            ...
            <div className="flex gap-2 mb-2">
                ...
                <div className="flex-1 bg-yellow-50 rounded-md p-2 text-center border border-yellow-100">
                    ...
                    <div className="font-bold text-yellow-600">{product.pending || 0}</div>
                </div>
            </div>
    ...
    const renderPagination = (currentPage, totalPages, onPageChange, totalItems, startItem, endItem) => (
                    ...
                    <div className="flex flex-col">
                        <div className="bg-green-600 text-white rounded-lg px-6 py-4 mb-4 shadow-sm">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-white">Healthy Stock Products</h3>
                                    <p className="text-sm text-green-50">{totalHealthyStock} products in good condition</p>
                                </div>
                            </div>
                        </div>
